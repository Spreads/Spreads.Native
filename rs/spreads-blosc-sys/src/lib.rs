...
extern "C" {
  ...
  ///should never happen.  If you see this, please report it back
  ///together with the buffer data causing this and compression settings.
  #[link_name = "\u{1}_blosc_compress_ctx"]
...
extern "C" {
  ...
  #[link_name = "\u{1}_blosc_decompress"]
...
extern "C" {
  ...
  ///output buffer is not large enough, then 0 (zero) or a negative value
  ///will be returned instead.
  #[link_name = "\u{1}_blosc_decompress_ctx"]
...
extern "C" {
  ...
  #[link_name = "\u{1}_blosc_get_compressor"]
...
extern "C" {
  ...
  ///the compressor (>=0).
  #[link_name = "\u{1}_blosc_set_compressor"]
...
extern "C" {
  ...
  #[link_name = "\u{1}_blosc_list_compressors"]
  pub fn blosc_list_compressors() -> *const libc::c_char;
}
extern "C" {
  #[link_name = "\u{1}_compress_lz4"]
  pub fn compress_lz4(
...
extern "C" {
  #[link_name = "\u{1}_decompress_zstd"]
...
extern "C" {
  #[link_name = "\u{1}_decompress_zlib"]
...
extern "C" {
  #[link_name = "\u{1}_compress_deflate"]
...
extern "C" {
  #[link_name = "\u{1}_decompress_deflate"]
...
extern "C" {
  #[link_name = "\u{1}_decompress_gzip"]
...
extern "C" {
  #[link_name = "\u{1}_decompress_noop"]
...
extern "C" {
  ...
  #[link_name = "\u{1}_blosc_internal_shuffle"]
...
extern "C" {
  #[link_name = "\u{1}_blosc_internal_bitshuffle"]
...
extern "C" {
  ...
  ///calling the hardware-accelerated routines because this method is both cross-
  ///platform and future-proof.
  #[link_name = "\u{1}_blosc_internal_unshuffle"]
...
extern "C" {
  #[link_name = "\u{1}_blosc_internal_bitunshuffle"]
