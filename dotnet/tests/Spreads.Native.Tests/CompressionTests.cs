...
namespace Spreads.Native.Tests
{
    ...
    public unsafe class CompressionTests
    {
        ...
        public const int ItemCount = 100_000;
        ...
        public void CouldShuffleUnshuffle()
        {
            ...
            for (int r = 0; r < rounds; r++)
            {
                using (Benchmark.Run("Shuffle", iterations * srcLen))
                {
                    ...
                    {
                        Compression.shuffle((IntPtr)itemSize, (IntPtr)srcLen, (byte*)originalPtr, (byte*)compressedPtr);
                ...
                using (Benchmark.Run("Unshuffle", iterations * srcLen))
                {
                    for (int i = 0; i < iterations; i++)
                    {
                        Compression.unshuffle((IntPtr)itemSize, (IntPtr)srcLen, (byte*)compressedPtr, (byte*)decompressedPtr);
